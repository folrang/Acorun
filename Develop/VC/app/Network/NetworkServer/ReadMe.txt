========================================================================
    콘솔 응용 프로그램 : NetworkServer 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 NetworkServer 응용 프로그램을 만들었습니다.

이 파일에는 NetworkServer 응용 프로그램을  구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.


NetworkServer.vcproj
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 NetworkServer.pch와
