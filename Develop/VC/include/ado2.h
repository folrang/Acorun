...
struct CADOJournalFieldInfo
{
	TCHAR m_szDate[10];
	TCHAR m_szSerialNumber[5];
	TCHAR m_szTimer[8];
	TCHAR m_szTransType[30];
	TCHAR m_szAccountNumber[20];
	LONG m_lAmount;
	TCHAR m_szTransMedia[10];
	TCHAR m_szTransResult[10];
	TCHAR m_szAddContents[50];
	TCHAR m_szNoReceve[100];
	TCHAR m_szCheque[200];
	TCHAR m_szCash[10];
	TCHAR m_szJournal[1024];
	TCHAR m_szFrontFaceImage1[MAX_PATH];
	TCHAR m_szFrontFaceImage2[MAX_PATH];
	TCHAR m_szFrontFaceImage3[MAX_PATH];
	TCHAR m_szFrontFaceImage4[MAX_PATH];
	TCHAR m_szFrontFaceImage5[MAX_PATH];
	TCHAR m_szEjectImage1[MAX_PATH];
	TCHAR m_szEjectImage2[MAX_PATH];
	TCHAR m_szEjectImage3[MAX_PATH];
	TCHAR m_szEjectImage4[MAX_PATH];
	TCHAR m_szEjectImage5[MAX_PATH];
	TCHAR m_szCardImage[MAX_PATH];
	TCHAR m_szGiro1[MAX_PATH];
	TCHAR m_szGiro2[MAX_PATH];
	TCHAR m_szGiro3[MAX_PATH];
	TCHAR m_szGiro4[MAX_PATH];
	TCHAR m_szGiro5[MAX_PATH];
	TCHAR m_szGiro6[MAX_PATH];
	TCHAR m_szGiro7[MAX_PATH];
	TCHAR m_szGiro8[MAX_PATH];
	TCHAR m_szGiro9[MAX_PATH];
	TCHAR m_szGiro10[MAX_PATH];
};

struct CADOTransSumFieldInfo
{
	TCHAR m_szDate[10];
	TCHAR m_szTransType[30];
	LONG m_lTransCount;
	LONG m_lTotalAmount;
	LONG m_lOneThousand;
	LONG m_lFiveThousand;
	LONG m_lTenThousand;
	LONG m_lFiftyThousand;
	LONG m_lOneHundredThousand;
	LONG m_lCheque;
};
